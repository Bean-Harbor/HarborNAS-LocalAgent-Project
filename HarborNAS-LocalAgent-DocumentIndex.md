...
### 5. **HarborNAS-Planner-TaskDecompose-Contract-v1.md**
**任务拆解规划器契约 v1（可执行）**

- 目标: 为 `planner.task_decompose` 提供可直接开发和测试的接口级契约。
...
### 7. **HarborNAS-CI-Contract-Pipeline-Checklist-v1.md**
**契约治理 CI 流水线清单 v1**

- 目标: 将契约治理要求映射为可自动执行的 CI 阶段与阻断规则。
