"""REST API endpoints for HarborClaw settings.
...
Endpoint summary
----------------
GET   /settings             → current HarborClaw config
PUT   /settings             → update HarborClaw config
...
from harborclaw.channels import Channel, ChannelConfig, ChannelRegistry
