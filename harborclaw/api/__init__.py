"""Persistent storage for HarborClaw settings.

Reads/writes ``/etc/harborclaw/settings.yaml`` (YAML) on HarborOS.
...
_SETTINGS_PATH = Path(os.environ.get(
    "HARBORCLAW_SETTINGS_PATH",
    "/etc/harborclaw/settings.yaml",
))


class SettingsStore:
    """Load / save HarborClaw settings from YAML or memory."""
