/**
 * HarborClaw Settings — TypeScript interfaces.
 *
 * Mirror the Python dataclasses in harborclaw/channels.py and
 * harborclaw/autonomy.py so the Angular UI speaks the same language
...
export interface HarborClawSettings {
