"""Tests for harborbeacon.long_connection — WebSocket/long-poll transports.
...
from harborbeacon.long_connection import (
    ConnectionState,
    ConnectionStatus,
    FeishuWsConfig,
    FeishuWsTransport,
...
class TestFeishuWsTransport:
    ...
    @patch("harborbeacon.long_connection.FeishuWsTransport._try_start_sdk", return_value=True)
    ...
    @patch("harborbeacon.long_connection.FeishuWsTransport._try_start_sdk", return_value=False)
