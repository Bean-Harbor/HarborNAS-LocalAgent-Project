...
def test_aiot_closeout_docs_lock_device_native_ownership() -> None:
    ...
    required_phrases = [
        ...
        "This round is VLM-first. The device lane should make image, snapshot, and still-frame artifacts easy to ingest later, while leaving continuous video and audio as follow-up work.",
