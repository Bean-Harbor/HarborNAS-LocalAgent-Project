# HarborNAS IM Gateway Agent Contract v1.4
...
14. HarborNAS build or contract test fails if direct IM platform credential usage remains in the notification delivery path after full cutover.
