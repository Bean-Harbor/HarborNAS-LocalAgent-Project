"""Autonomy level mapping for HarborBeacon.

HarborBeacon uses three autonomy levels (inherited from ZeroClaw):
...
class Autonomy(str, Enum):
    """HarborBeacon autonomy levels (ReadOnly / Supervised / Full)."""
    READ_ONLY = "ReadOnly"
...
def autonomy_to_approval(
    ...
    """Convert a HarborBeacon autonomy level to an ApprovalContext.
...
def risk_to_autonomy(risk: RiskLevel) -> Autonomy:
    """Suggest the minimum HarborBeacon autonomy level needed for a risk level."""
